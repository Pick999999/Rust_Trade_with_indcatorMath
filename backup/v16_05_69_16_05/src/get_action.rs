...
pub struct AnalysisObject {
    ...
    #[serde(rename = "emaAbove")]
    pub ema_above: String,
    #[serde(rename = "emaLongDirection")]
    pub ema_long_direction: String,
    
    #[serde(rename = "isEmaShortCutType")]
    pub is_ema_short_cut_type: String,
    
    #[serde(rename = "isEmaShortTurnType")]
    pub is_ema_short_turn_type: String,
    
    #[serde(rename = "isEmaMediumTurnType")]
    pub is_ema_medium_turn_type: String,
    
    #[serde(rename = "atrValue")]
    pub atr_value: f64,
    #[serde(rename = "choppiNessIndex")]
